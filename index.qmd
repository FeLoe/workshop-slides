...
:::
::: {.column width="50%"}
**Path A (Quarto) also needs:**
:::{.step}
**Quarto** — [quarto.org](https://quarto.org) → Get Started
check: `quarto --version`
:::

**Path B (Hugo) also needs:**
:::{.step}
**Hugo** (extended) — check: `hugo version`
Mac: `brew install hugo`
Windows: [github.com/gohugoio/hugo/releases](https://github.com/gohugoio/hugo/releases)
:::
:::{.step}
**Go** — check: `go version`
Mac: `brew install go` · [go.dev/dl](https://go.dev/dl)
:::
:::
::::
